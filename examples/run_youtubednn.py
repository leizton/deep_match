...
from preprocess import gen_data_set_youteube, gen_model_input
...
if __name__ == "__main__":
    ...
    item_feature_columns = [SparseFeat('movie_id', feature_max_idx['movie_id'], embedding_dim, embedding_name='movie_id')]
